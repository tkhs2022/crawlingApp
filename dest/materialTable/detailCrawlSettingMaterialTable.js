...
exports.default = DetailCrawlSettingMaterialTable;
...
function DetailCrawlSettingMaterialTable(props) {
  ...
  var editableDetailCrawlSetting = /*#__PURE__*/_react.default.createElement(_materialTable.default, (_React$createElement = {
    title: "\u5BFE\u8C61\u30C7\u30FC\u30BF\u30BB\u30C3\u30C8",
    ...
    editable: {
      ...
      onRowDelete: function onRowDelete(oldData) {
        return new Promise(function (resolve, reject) {
          ...
          _showContentsArea.Crawlings.setDeleteCrawlingList(response);
    ...
    icons: tableIcons
  }, _defineProperty(_React$createElement, "options", {
    showTitle: true,
    search: false,
    tableLayout: "auto",
    overflowX: "scroll",
  ...
  }), _defineProperty(_React$createElement, "actions", [{
    ///////////////////////////////////////////////////////////////// 
    // クロール対象データの編集処理
    icon: _Edit.default,
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: "materialDetailCrawlSetting",
    style: {
      maxWidth: "36%",
      minWidth: "36%",
      padding: "0.5em",
